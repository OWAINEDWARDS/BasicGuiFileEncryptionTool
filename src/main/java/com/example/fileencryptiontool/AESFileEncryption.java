...
public class AESFileEncryption {
     ...
     * @throws IOException
     */
    public void encrypt(int keyLength, char[] password, InputStream input, OutputStream output)
     ...
     * @throws IOException
     */
    public int decrypt(char[] password, InputStream input, OutputStream output)
